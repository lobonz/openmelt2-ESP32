...
#define SERVO_PWM_COAST_PERCENT 0.9f         // Set to a value between 0.0-1.0 to make coast use a % of current throttle
                                             // 0.0 = neutral position (1500μs), 0.5 = 50% of current throttle
                                             // Helps prevent voltage spikes when using damped mode in ESCs

#define SERVO_PWM_TRANSLATE_PERCENT 1.1f     // Set to a value above 1.0 to make translation use a % greater than current throttle
                                             // 1.0 = 100% current throttle, 1.1 = 110% of current throttle (will be capped at 2000μs)
                                             // Helps prevent voltage spikes when using damped mode in ESCs
